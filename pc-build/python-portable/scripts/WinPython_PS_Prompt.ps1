...
if (-not ($env:WINPYDIR -eq [System.IO.Path]::GetFullPath( $env:WINPYDIRBASE+"\python-3.11.9.amd64")) ) {


$env:WINPYDIR = $env:WINPYDIRBASE+"\python-3.11.9.amd64"
