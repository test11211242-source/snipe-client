...
echo -e "${BLUE}╔════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║      CR Tools - Публикация обновления     ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════╝${NC}"
echo ""
...
INSTALLER_PATH="/home/ubuntu/snipe/data/updates/downloads/CR_Tools_Setup_${NEW_VERSION}.exe"
if [ -f "$INSTALLER_PATH" ]; then
    FILE_SIZE=$(stat -c%s "$INSTALLER_PATH")
    echo -e "${GREEN}✓ Установщик: CR_Tools_Setup_${NEW_VERSION}.exe ($FILE_SIZE bytes)${NC}"
else
...
echo -e "${BLUE}URL обновления: ${NC}https://updates.artcsworld.xyz/api/app/latest.yml"
echo ""
